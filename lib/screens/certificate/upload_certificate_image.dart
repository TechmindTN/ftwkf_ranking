...
class UploadCertificateImages extends StatefulWidget {
  const UploadCertificateImages({super.key});

  @override
  State<UploadCertificateImages> createState() =>
      _UploadCertificateImagesState();
}

class _UploadCertificateImagesState
    extends State<UploadCertificateImages> {
      ...
      return Directionality(
        ...
        child: Scaffold(
          ...
          body: CustomScrollView(
            slivers: [
              MySliverAppBar(
                  "صورة الشهادة", context, false, licenceController, false,true),
              SliverToBoxAdapter(
                child: Center(
                //   child: Column(
                ...
                //                   )
                                  child: Column(
                                    children: [
                                      CertificateImageUploadWidget('صورة الحساب',certificateController,context,'profilePhoto',certificateController.createdCertificate.image,0),
                ...
                SizedBox(
                    ...
                    child: FloatingActionButton.extended(
                      onPressed: () {
                        ...
                        if (
                          // (licenceController.createdFullLicence!.profile!.profilePhoto == null) ||
                          //   (licenceController
                          ...
                          GoRouter.of(context).push(Routes.AddCertificateScreen);
                        }

...
class EditAthleteLicenceScreen extends StatefulWidget{
  const EditAthleteLicenceScreen({super.key});

  @override
  State<EditAthleteLicenceScreen> createState() => _EditAthleteLicenceScreenState();
}

class _EditAthleteLicenceScreenState extends State<EditAthleteLicenceScreen> {
...
//  licenceController.selectedSex=licenceController.currentFullLicence!.profile!.sexe!;

  ...
  Widget build(BuildContext context) {
    return Consumer<LicenceProvider>(
      ...
      return Directionality(
        ...
        child: Scaffold(
          appBar: AppBar(
            title: const Text(" اضافة اجازة رياضي"),
          ),
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                //     licenceController),
                DisciplineSelectInput('رياضة',
                    licenceController.selectedDiscipline, licenceController),
      
                WeightSelectInput('وزن', licenceController.selectedWeight,
                    licenceController),
                      ...
                      onPressed: () {
                        ...
                        if (
                          ...
                          //   (licenceController.selectedCategory!.id == -1) ||
                            // (licenceController.currentUser.club!.id == null)&&
